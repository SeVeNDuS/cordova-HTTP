...
public class CordovaHttpPlugin extends CordovaPlugin {
    ...
    public boolean execute(String action, final JSONArray args, final CallbackContext callbackContext) throws JSONException {
        ...
        } else if (action.equals("payload")) {
            String urlString = args.getString(0);
            JSONObject params = args.getJSONObject(1);
            JSONObject headers = args.getJSONObject(2);
            HashMap<?, ?> paramsMap = this.getMapFromJSONObject(params);
            HashMap<String, String> headersMap = this.addToMap(this.globalHeaders, headers);
            CordovaHttpPayload payload = new CordovaHttpPayload(urlString, paramsMap, headersMap, callbackContext);
            cordova.getThreadPool().execute(payload);
